...
public class RouteServlet extends BaseServlet {
    ...
    /**
        ...
        public void pageQuery(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if(uid==0){
                ...
                //3. 调用service查询PageBean对象
                PageBean<Route> pb = routeService.pageQuery2(uid, currentPage, pageSize);
    ...
    public void findOne(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        route.setCategory(routeService.findOneCategory(rid));
    ...
    public void favoriteRank(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       List<Route> ab=favoriteService.searchfavoriteCount();
        writeValue(ab,response);
